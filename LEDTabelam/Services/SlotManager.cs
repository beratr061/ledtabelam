...
/// Requirements: 20.1, 20.6, 20.7, 20.8, 20.9, 20.10
/// </summary>
public class SlotManager : ISlotManager
{
    ...
    public async Task ImportSlotsAsync(string filePath, bool overwrite = false)
    {
        ...
        foreach (var kvp in importData.Slots)
        {
            ...
            {
                continue; // Geçersiz slot numarasını atla
            }
    ...
    /// <summary>
    /// Slot numarasının geçerli aralıkta olduğunu doğrular
    /// </summary>
    ...
    /// <summary>
    /// Slotları yükler (profil yüklenirken kullanılır)
    /// </summary>
    ...
    /// <summary>
    /// Mevcut slotları dictionary olarak döndürür
    /// </summary>
